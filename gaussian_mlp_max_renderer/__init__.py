...
from scene.gaussian_model_mlp_HB import GaussianModelMLP_HB
from utils.sh_utils import eval_sh


def render(
    viewpoint_camera,
    pc: GaussianModelMLP_HB,
    pipe,
    ...
    frequencies = pc.get_frequencies 
    phases = pc.get_phases 

    amplitudes = pc.get_amplitudes
    ...
    frequencies_boosted = frequencies * pc.omega
    phases_boosted = phases * pc.omega
    ...
    # amplitudes_boosted = torch.log(1 - 0.99 * torch.sigmoid(amplitudes))
    # offsets_boosted = torch.log(1 - 0.99 * torch.sigmoid(offsets))
    # rendered_image, radii, _ = rasterizer(
    #     means3D=means3D,
    #     means2D=means2D,
    #     shs=shs,
    ...
    #     weight1=frequencies_boosted,
    #     bias1=phases_boosted,
    #     weight2=amplitudes_boosted,
    #     bias2=offsets_boosted,
    #     cov3D_precomp=cov3D_precomp,
    # )
